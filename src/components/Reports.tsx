...
export default function Reports({ user, profile }: ReportsProps) {
  ...
  return (
    <div className="space-y-6 sm:space-y-12">
      <div>
        <h2 className="text-xl sm:text-4xl font-bold tracking-tight text-text-main">Performance Analysis</h2>
        <p className="text-xs sm:text-sm text-text-muted mt-1 sm:mt-2">Patterns of life across the last 7 days.</p>
      </div>
