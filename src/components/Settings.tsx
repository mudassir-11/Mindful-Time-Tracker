...
import { Trash2, Plus, Palette, Settings as SettingsIcon } from 'lucide-react';
...
export default function Settings({ user, profile, onProfileUpdate }: SettingsProps) {
  ...
  return (
    <div className="space-y-6 sm:space-y-12">
      <div>
        <h2 className="text-xl sm:text-4xl font-bold tracking-tight text-text-main">Settings</h2>
        <p className="text-xs sm:text-sm text-text-muted mt-1 sm:mt-2">Customize your experience and manage your categories.</p>
      </div>
