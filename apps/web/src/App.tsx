      ...
      <div className="min-h-screen flex flex-col items-center justify-center bg-background p-6">
        ...
        >
          <div className="flex justify-center">
            <div className="w-16 h-16 bg-primary rounded-xl flex items-center justify-center shadow-lg shadow-primary/20 overflow-hidden">
              <img src="/icon.svg" alt="Prism Logo" className="w-full h-full object-cover" />
            </div>
          </div>
          <div className="space-y-4">
            <h1 className="text-4xl font-bold tracking-tight text-text-main">Prism</h1>
    ...
    <div className="min-h-screen bg-background flex flex-col md:flex-row pb-20 md:pb-0 font-sans">
      ...
      <aside className="hidden md:flex flex-col w-64 bg-surface border-r border-border p-6 h-screen sticky top-0">
        <div className="flex items-center gap-3 mb-8 px-1">
          ...
          <span className="text-xl font-bold tracking-tight text-text-main">Prism</span>
        </div>
