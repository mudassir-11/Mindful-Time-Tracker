      ...
      >
        ...
        <div className="space-y-4">
          ...
          <p className="text-text-muted italic leading-relaxed">
            A simple space to log your life, hour by hour. Be honest, be focused, and watch how you grow.
          </p>
        </div>
        ...
        <ul className="text-left space-y-4">
          ...
          <li className="flex items-start gap-3">
            <CheckCircle2 className="w-5 h-5 text-primary flex-shrink-0 mt-0.5" />
            <span className="text-sm">Reflect daily in your Prism journal.</span>
          </li>
        </ul>

        <button 
          onClick={onComplete}
          className="w-full py-4 bg-primary text-white rounded-2xl font-bold hover:scale-[1.02] active:scale-[0.98] transition-all shadow-lg shadow-primary/20"
        >
          Begin tracking
        </button>
      </motion.div>
