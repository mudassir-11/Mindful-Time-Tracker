  ...
  return (
    <div className="space-y-4 sm:space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-3xl sm:text-4xl font-bold tracking-tight text-text-main">Intentions</h2>
          <p className="text-sm sm:text-base text-text-muted mt-1 sm:mt-2">Set, track, and align with your deeper goals.</p>
        </div>
        <button 
